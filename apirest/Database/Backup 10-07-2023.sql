...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de proveedores	';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `vw_comprascabecerasimple`
--

DROP TABLE IF EXISTS `vw_comprascabecerasimple`;
/*!50001 DROP VIEW IF EXISTS `vw_comprascabecerasimple`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_comprascabecerasimple` AS SELECT 
...
--
-- Temporary view structure for view `vw_productosyrubros`
--

DROP TABLE IF EXISTS `vw_productosyrubros`;
/*!50001 DROP VIEW IF EXISTS `vw_productosyrubros`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_productosyrubros` AS SELECT 
 1 AS `idproductos`,
 1 AS `codigobarra`,
 1 AS `nombreproducto`,
 1 AS `descripcion`,
...
--
-- Final view structure for view `vw_comprascabecerasimple`
--
...
/*!50001 VIEW `vw_comprascabecerasimple` AS select `comprascabecera`.`idcomprascabecera` AS `idcomprascabecera`,`comprascabecera`.`fecha` AS `fecha`,`comprascabecera`.`comprobante_cabecera` AS `comprobante_cabecera`,`comprascabecera`.`idproveedores_cabecera` AS `idproveedores_cabecera`,`comprascabecera`.`totalcompra` AS `totalcompra`,`proveedores`.`idproveedores` AS `idproveedores`,`proveedores`.`nombre` AS `nombre` from (`comprascabecera` join `proveedores` on((`comprascabecera`.`idproveedores_cabecera` = `proveedores`.`idproveedores`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_existencias` AS select `productos`.`idproductos` AS `idproductos`,`productos`.`nombreproducto` AS `nombre`,`productos`.`existencia` AS `existencia` from `productos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `vw_productosyrubros`
--
...
-- Dump completed on 2023-07-10 21:51:20
