...
class RubrosController {
     ...
     public async getRubro(req: Request, res: Response): Promise<any> {
          const { id } = req.params;
     ...
     // Agrega un rubro
     public async addRubro(req: Request, res: Response): Promise<void> {
          const body = req.body;
     ...
     public async updateRubro(req: Request, res: Response): Promise<void> {
          const { id } = req.params;
     ...
     public async deleteRubro(req: Request, res: Response): Promise<void> {
          const { id } = req.params;
